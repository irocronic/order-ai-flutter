// lib/widgets/editable_order_item_card.dart
...
/// Sipariş detay ekranlarında tek bir sipariş kalemini görüntüleyen ve etkileşim sağlayan widget.
class EditableOrderItemCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String tableUser = item.tableUser ?? "";
    ...
    return Card(
      ...
      clipBehavior: Clip.antiAlias, // Bu önemli
      child: Column(
        children: [
          Padding(
          ...
          // İçerik artık Expanded ve SingleChildScrollView ile sarıldı.
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(l10n.lineItemTotal(CurrencyFormatter.format(itemLineTotal), ''), 
                  ...
                  if (tableUser.isNotEmpty)
                    Padding(
                      ...
                      child: Text(
                        l10n.tableOwnerLabel(tableUser),
                        style:
                        TextStyle(fontSize: 12, color: Colors.grey.shade600, decoration: isDelivered ? TextDecoration.lineThrough : null),
                      ),
                    ),
                ],
              ),
