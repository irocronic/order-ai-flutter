...
class BusinessOwnerHomeContent extends StatefulWidget {
  ...
  @override
  State<BusinessOwnerHomeContent> createState() =>
      _BusinessOwnerHomeContentState();
}
...
class _BusinessOwnerHomeContentState extends State<BusinessOwnerHomeContent> {
  ...
  void _filterMenuItems() {
    ...
    for (var section in accessibleSections) {
      ...
      if (filteredItems.isNotEmpty) {
        newFilteredList
            .add(HomeMenuSection(title: section.title, items: filteredItems));
      }
    }
  ...
  bool _canAccess(String permissionKey, bool requiresBusinessOwner) {
    if (UserSession.userType == 'business_owner') {
      return true; // İşletme sahibi her şeyi görebilir
    }
    if (requiresBusinessOwner) {
      return false; // Personel, sadece işletme sahibine özel alanları göremez
    }
    if (permissionKey.isEmpty) {
      return true; // İzin anahtarı boşsa herkes erişebilir
    }
  ...
  Widget _buildGridItem(BuildContext context, HomeMenuItem itemData) {
    final bool showStockAlert =
        itemData.permissionKey == PermissionKeys.manageStock &&
            widget.hasStockAlerts;
                        ...
                        GridView.builder(
                          ...
                          itemBuilder: (context, itemIndex) {
                            return _buildGridItem(
                                context, section.items[itemIndex]);
                          },
                        ),
                      ],
                    );
      ...
      HomeMenuSection(
        ...
        items: [
          HomeMenuItem(
              ...
              title: l10n.homeMenuActiveTableOrders,
              baseColor: Colors.red.shade400,
              permissionKey: PermissionKeys.takeOrders,
              onTapBuilder: (ctx) => () => widget.onTabChange(1)),
          HomeMenuItem(
              icon: Icons.delivery_dining_outlined,
              title: l10n.homeMenuActiveTakeawayOrders,
              baseColor: Colors.deepOrange.shade400,
              permissionKey: PermissionKeys.takeOrders,
              onTapBuilder: (ctx) => () => widget.onTabChange(2)),
          HomeMenuItem(
              icon: Icons.kitchen_outlined,
              title: l10n.homeMenuKds,
              baseColor: Colors.deepOrange.shade600,
              permissionKey: PermissionKeys.manageKds,
              onTapBuilder: (ctx) => widget.onNavigateToKds),
          HomeMenuItem(
              icon: Icons.history_outlined,
              title: l10n.homeMenuCompletedOrders,
              baseColor: Colors.lightGreen.shade600,
              permissionKey: PermissionKeys.viewCompletedOrders,
          ...
          HomeMenuItem(
              ...
              title: l10n.homeMenuCreditSales,
              baseColor: Colors.amber.shade700,
              permissionKey: PermissionKeys.manageCreditSales,
              onTapBuilder: (ctx) => () => Navigator.push(
                  ctx,
                  MaterialPageRoute(
      ...
      HomeMenuSection(
        ...
        items: [
          HomeMenuItem(
              ...
              title: l10n.homeMenuCategoryManagement,
              permissionKey: PermissionKeys.manageMenu,
          ...
          HomeMenuItem(
              ...
              title: l10n.homeMenuProductVariants,
              permissionKey: PermissionKeys.manageMenu,
              baseColor: Colors.indigo.shade600,
              onTapBuilder: (ctx) => () => Navigator.push(
                  ctx,
                  MaterialPageRoute(
                      builder: (_) => ManageVariantListScreen(
                          token: widget.token,
                          businessId: widget.businessId)))),
          HomeMenuItem(
          ...
          HomeMenuItem(
              ...
              title: l10n.homeMenuSupplierManagement,
          ...
          HomeMenuItem(
              ...
              title: l10n.homeMenuPurchaseOrders,
          ...
          HomeMenuItem(
              ...
              title: l10n.homeMenuCampaignManagement,
              baseColor: Colors.amber.shade700,
              ...
              onTapBuilder: (ctx) => () => Navigator.push(
                  ctx,
                  MaterialPageRoute(
                      builder: (_) => ManageCampaignsScreen(
                          token: widget.token,
                          businessId: widget.businessId)))),
        ],
      ),
      ...
      HomeMenuSection(
        ...
        items: [
          ...
          HomeMenuItem(
              ...
              title: l10n.homeMenuShiftAssignment,
          ...
          HomeMenuItem(
              ...
              permissionKey: PermissionKeys.manageTables,
              onTapBuilder: (ctx) => () => Navigator.push(
                  ctx,
                  MaterialPageRoute(
                      builder: (_) => ManageTableScreen(
                          token: widget.token,
                          businessId: widget.businessId)))),
          HomeMenuItem(
              icon: Icons.settings_applications_outlined,
              title: l10n.homeMenuKdsSettings,
          ...
          HomeMenuItem(
              ...
              title: l10n.homeMenuPagerManagement,
              ...
              onTapBuilder: (ctx) => () => Navigator.push(
                  ctx,
                  MaterialPageRoute(
                      builder: (_) => const PagerManagementScreen()))),
          HomeMenuItem(
          ...
          HomeMenuItem(
              ...
              title: l10n.homeMenuAccountSettings,
              baseColor: Colors.grey.shade600,
              permissionKey: PermissionKeys.viewAccountSettings,
              onTapBuilder: (ctx) => () => Navigator.push(
                  ctx,
                  MaterialPageRoute(
                      builder: (_) =>
