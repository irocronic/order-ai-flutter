    ...
    return [
      ...
      HomeMenuSection(
        ...
        items: [
          ...
          HomeMenuItem(
            ...
            title: l10n.homeMenuStockManagement, 
            permissionKey: PermissionKeys.manageStock, 
      ...
      HomeMenuSection(
        ...
        items: [
          HomeMenuItem(
            ...
            title: l10n.homeMenuTableManagement, 
          ...
          HomeMenuItem(
            ...
            title: l10n.homeMenuStaffSchedule, 
      ...
      HomeMenuSection(
        ...
        items: [
          HomeMenuItem(
            icon: Icons.receipt_long_outlined, 
            title: l10n.homeMenuGeneralReport, 
      ...
      HomeMenuSection(
        ...
        items: [
          ...
          HomeMenuItem(
            ...
            onTapBuilder: (ctx) => () => Navigator.push(
              ctx, 
              MaterialPageRoute(builder: (_) => const PagerManagementScreen())
            )
          ),
          HomeMenuItem(
